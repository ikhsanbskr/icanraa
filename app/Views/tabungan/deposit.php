      ...
      <div class="card-body">
        ...
        <p class="mb-0">
          <span class="badge bg-info me-1">
            <i class="mdi mdi-arrow-up-bold"></i> <?= ($peningkatan < 0) ? '0' : round($peningkatan, 2) ?>%</span>
  ...
  <div class="col-xxl-6 col-lg-6">
    <div class="card widget-flat bg-primary text-white">
      <div class="card-body">
        ...
        <h3 class="mt-3 mb-3 text-white">Rp<?= buatRupiah($pemasukan['deposit_pemasukan']) ?></h3>
        <p class="mb-0">
          <span class="badge bg-info me-1">
            <i class="mdi mdi-arrow-up-bold"></i> <?= ($peningkatan_user < 0) ? '0' : round($peningkatan_user, 2) ?>%</span>
          <span class="text-nowrap">Dari bulan lalu</span>
        </p>
      </div>
    </div>
  ...
  <div class="col-sm-12">
    <div class="card">
      <div class="card-body">
        ...
        <h4 class="header-title mb-3">TRANSAKSI DEPOSIT</h4>
